...
> V2012 후속 조정: 사용자가 V2011 라이브값 확인 후 다시 2배 상향을 지시했다. `BATTLE_SUIT_DAMAGE_MULTIPLIER`는 2→4, 노출되는 유효 PVE 화력은 x4→x8이다. 일반 사격과 아포칼립스 관통 모두 `5229a86f` 대비 정확히 2배이며 발사 시계와 게이트 공식은 유지한다.
