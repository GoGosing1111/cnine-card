...
assert.match(app,/project-v-pixi-battle\.bundle\.js\?v=99-skill-chip-runtime/);
...
assert.match(previewClient,/project-v-pixi-battle\.bundle\.js\?v=99-skill-chip-runtime/);
