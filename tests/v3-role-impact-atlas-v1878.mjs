...
assert.match(previewIndex,/project-v-client\.js\?v=60-suit23-user-reference/);
assert.match(previewClient,/project-v-pixi-battle\.bundle\.js\?v=81-suit23-user-reference/);
