...
assert.match(app,/project-v-pixi-battle\.bundle\.js\?v=92-authoritative-battle-suit-live/);
assert.match(index,/js\/app\.js\?v=1972-battle-suit-live/);
assert.match(previewIndex,/project-v-client\.js\?v=71-authoritative-battle-suit-live/);
assert.match(previewClient,/project-v-pixi-battle\.bundle\.js\?v=92-authoritative-battle-suit-live/);
