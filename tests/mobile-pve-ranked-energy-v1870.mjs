...
test('ranked fatigue remains visible and live-labelled on mobile and short landscape screens', async () => {
  ...
  assert.match(index,/app\.js\?v=(?:1874-burning-header-dock|1880-navigation-deck-rules|1881-workshop-split-lineage|1882-menu-pve-scrapyard|1884-zenith-ojoeun-sd)/);
});
