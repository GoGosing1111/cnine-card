...
export async function lootFixture(t,{postgres=false}={}){
 ...
 const shopPolicy=structuredClone(LOOT_SHOP_DEFAULTS);shopPolicy.salesEnabled=true;shopPolicy.rewardsEnabled=true;for(const s of shopPolicy.sources){s.enabled=true;s.amount=10;}
