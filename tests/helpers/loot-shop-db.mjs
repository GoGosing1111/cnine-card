...
export async function lootFixture(t,{postgres=false}={}){
 ...
 await f.p("INSERT INTO character_equipment_items(id,code,name,rarity,image_url) VALUES(37,'BATTLE_SUIT_02','F바디','SPECIAL','assets/items/pig-coin-v1.png'),(900,'MYSTIC_TEST','미스틱 검수 장비','MYTHIC','assets/items/pig-coin-v1.png')").run();
