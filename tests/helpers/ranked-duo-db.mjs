...
export async function duoFixture(t,{postgres=false}={}){
 ...
 const config={...structuredClone(DUO_DEFAULTS),visible:true,startsAt:new Date(now+24*3600000).toISOString(),endsAt:new Date(now+14*86400000).toISOString(),energy:{maximum:10,dailyGrant:10,cost:1}};
