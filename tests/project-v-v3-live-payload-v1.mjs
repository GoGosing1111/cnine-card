...
assert.match(app,/project-v-pixi-battle\.bundle\.js\?v=93-battle-suit-continuous-fire/);
assert.match(app,/battle-v3-live\.js\?v=3\.27\.0-battle-suit-continuous-fire/);
...
assert.match(index,/js\/app\.js\?v=1973-battle-suit-continuous-fire/);
assert.match(serviceWorker,/soop-card-shell-v1973-battle-suit-continuous-fire/);
