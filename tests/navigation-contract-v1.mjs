...
assert.match(appSource, /scrapyard:\{[\s\S]*?css\/workshop-v1881\.css\?v=2009-material-label[\s\S]*?js\/workshop-v1881\.js\?v=2096-combat-flow/);
assert.match(appSource, /js\/scrapyard-battle-v1698\.js\?v=2096-combat-flow/);
