...
assert.match(live,/const VERSION = '3\.7\.0-session-reset'/);
assert.match(app,/project-v-pixi-battle\.bundle\.js\?v=51-session-reset/);
assert.match(app,/battle-v3-live\.js\?v=3\.7\.0-session-reset/);
