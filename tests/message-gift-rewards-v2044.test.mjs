...
test('gift rewards are allowed by verified sending route and use a fresh paired client cache',()=>{
  ...
  assert.match(read('index.html'),/js\/app\.js\?v=2053-player-calling-card-empty-fx/);
  assert.match(read('service-worker.js'),/soop-card-shell-v2053-player-calling-card-empty-fx/);
});
