...
test('아포칼립스 보스 71/72는 승인된 투명 SD로 전투에만 연결된다',async()=>{
  ...
  assert.match(adapterSource,/manifest-v1\.json\?v=7-apocalypse-edward-kenshin/);
  assert.match(appSource,/project-v-monster-battle-art-adapter-v1\.js\?v=5\.3\.0-apocalypse-edward-kenshin/);
  assert.match(indexSource,/responsive-battle-sprites-v1815\.js\?v=1958-zenith-apocalypse-sd/);
  for(const item of expected){
