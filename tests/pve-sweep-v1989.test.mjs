...
test('소탕 전용 UI와 캐시 버전이 운영 셸에 연결된다',()=>{
  ...
  assert.match(index,/js\/app\.js\?v=2092-cow-tower-on/);
  assert.match(index,/css\/pve-command-v2\.css\?v=2092-cow-tower-on/);
  assert.match(index,/js\/pve-command-v2-live\.js\?v=2092-cow-tower-on/);
