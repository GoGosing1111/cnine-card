...
for (const asset of [
  'js/app.js?v=1921-inventory-reroll-route',
  'js/responsive-superstar-battle-sprites-v1896.js?v=1904-superstar-son-zeus-sd',
  'css/pve-command-v2.css?v=1882-menu-pve-scrapyard',
  'css/information-architecture-v1880.css?v=1880-navigation-deck-rules',
  'js/pve-command-v2-live.js?v=1908-joeun-gamst-visibility',
...
assert.ok(serviceWorker.includes("soop-card-shell-v1916-territory-100-attack-reward"));
...
assert.ok(exactShell.includes("VERSION = '21.14.0'"));
assert.ok(!exactShell.includes('시즌 · 카드점수'));
assert.ok(router.includes("version: '1.5.0'"));
