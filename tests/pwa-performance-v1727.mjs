...
assert.match(worker,/const SHELL_CACHE='soop-card-shell-v1727'/);
...
assert.match(index,/runtime-performance-v1727\.css\?v=1727-offscreen-paint-stop/);
assert.match(index,/runtime-performance-v1727\.js\?v=1727-offscreen-lifecycle/);
assert.match(index,/app\.js\?v=1727-partial-shell-render/);
assert.match(index,/battle-v2-live\.js\?v=1727-offscreen-webgl-cleanup/);
