...
test('번들이 소스와 같은 계약을 담고 있다', () => {
  ...
  const bannerSources=read('preview/project-v-v3/source/battle/BikiniJoeunCombatPlayback.js')+read('preview/project-v-v3/source/battle/RagnielCombatPlayback.js')+read('preview/project-v-v3/source/battle/MangisaCombatPlayback.js')+engineSrc+read('preview/project-v-v3/source/battle/MercenaryCombatPlayback.js')+read('preview/project-v-v3/source/battle/ApocalypseLegionPlayback.js')+read('preview/scrapyard-v3-v1/source/ScrapyardBattleEngine.js');
...
test('캐시 태그가 갱신되어 있다', () => {
  ...
  assert.match(read('service-worker.js'), /const SHELL_CACHE='soop-card-shell-v2108-shared-navigation'/);
});
