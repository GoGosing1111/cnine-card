...
test('캐시 태그가 갱신되어 있다', () => {
  assert.match(appSrc, /project-v-pixi-battle\.bundle\.js\?v=103-cow-native/);
  assert.match(read('service-worker.js'), /const SHELL_CACHE='soop-card-shell-v2093-native-pve-hyper'/);
});
