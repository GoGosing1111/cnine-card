...
assert.match(index,/js\/app\.js\?v=2053-player-calling-card-empty-fx/,'라이브 앱 캐시 버전을 갱신해야 합니다.');
assert.match(index,/js\/evolution\.js\?v=2045-selection-perf/,'진화 화면 캐시 버전을 갱신해야 합니다.');
