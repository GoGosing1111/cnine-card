...
for(const token of [
  ...
  'preview/project-v-v3/project-v-pixi-battle.bundle.js?v=103-cow-native',
...
assert.ok(index.includes('js/app.js?v=2093-native-pve-hyper'));
...
assert.ok(index.includes('js/tower-v1038.js?v=2093-native-pve-hyper'));
