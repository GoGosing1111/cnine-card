...
assert.doesNotMatch(index,/scrapyard-battle-v1698/);
assert.match(app,/css\/scrapyard-battle-v1698\.css\?v=1720-monster-card-compact/);
assert.match(app,/js\/scrapyard-battle-v1698\.js\?v=1703-fast-entry/);
