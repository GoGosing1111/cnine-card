...
test('v1899 일괄 강화 리소스와 앱 셸 캐시는 함께 버전이 오른다', () => {
  ...
  assert.match(index, /js\/app\.js\?v=1921-inventory-reroll-route/i);
  assert.match(serviceWorker, /SHELL_CACHE\s*=\s*['"]soop-card-shell-v1916-territory-100-attack-reward['"]/i);
});
