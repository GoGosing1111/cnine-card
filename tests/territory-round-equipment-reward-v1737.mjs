...
assert.match(index,/territory-war-v1811\.css\?v=1824-territory-command-map/);
assert.match(serviceWorker,/soop-card-shell-v1824-territory-command-map/);
