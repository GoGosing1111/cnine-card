...
assert.match(index, /js\/app\.js\?v=(?:1879-player-ultimate-skip|1880-navigation-deck-rules|1881-workshop-split-lineage)/, 'app cache key must preserve or supersede the ultimate-skip release');
...
assert.match(worker, /soop-card-shell-v(?:1879-player-ultimate-skip|1880-navigation-deck-rules|1881-workshop-split-lineage)/, 'service worker shell cache must preserve or supersede the ultimate-skip release');
