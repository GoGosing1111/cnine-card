...
assert.match(index, /js\/app\.js\?v=1941-superstar-pack-early-access/, 'app cache key must preserve or supersede the ultimate-skip release');
assert.match(index, /js\/pve-command-v2-live\.js\?v=(?:1879-player-ultimate-skip|1880-navigation-deck-rules|1882-menu-pve-scrapyard|1908-joeun-gamst-visibility|1930-raid-entry-loader)/, 'PVE UI cache key must preserve or supersede the ultimate-skip release');
...
assert.match(worker, /soop-card-shell-v1941-superstar-pack-early-access/, 'service worker shell cache must preserve or supersede the ultimate-skip release');
