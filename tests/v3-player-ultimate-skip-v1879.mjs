...
assert.match(index, /js\/app\.js\?v=1940-superstar-advancement/, 'app cache key must preserve or supersede the ultimate-skip release');
...
assert.match(worker, /soop-card-shell-v1940-superstar-advancement/, 'service worker shell cache must preserve or supersede the ultimate-skip release');
