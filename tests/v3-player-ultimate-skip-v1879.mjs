...
assert.match(index, /js\/app\.js\?v=1937-unique-advancement-ui/, 'app cache key must preserve or supersede the ultimate-skip release');
...
assert.match(worker, /soop-card-shell-v1937-unique-advancement-ui/, 'service worker shell cache must preserve or supersede the ultimate-skip release');
