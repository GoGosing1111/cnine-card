...
assert.match(index, /js\/app\.js\?v=(?:1879-player-ultimate-skip|1880-navigation-deck-rules|1881-workshop-split-lineage|1882-menu-pve-scrapyard|1884-zenith-ojoeun-sd|1904-superstar-son-zeus-sd)/, 'app cache key must preserve or supersede the ultimate-skip release');
...
assert.match(worker, /soop-card-shell-v(?:1879-player-ultimate-skip|1880-navigation-deck-rules|1881-workshop-split-lineage|1882-menu-pve-scrapyard|1884-zenith-ojoeun-sd|1885-static-high-grade-frame|1904-superstar-son-zeus-sd)/, 'service worker shell cache must preserve or supersede the ultimate-skip release');
