...
assert.match(index, /js\/app\.js\?v=1935-battlefield-unique-fix/, 'app cache key must preserve or supersede the ultimate-skip release');
...
assert.match(worker, /soop-card-shell-v1935-battlefield-unique-fix/, 'service worker shell cache must preserve or supersede the ultimate-skip release');
