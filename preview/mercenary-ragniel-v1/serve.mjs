...
const root=path.resolve(fileURLToPath(new URL('../..',import.meta.url))),port=Number(process.env.RAGNIEL_PREVIEW_PORT||8807);
...
}).listen(port,'127.0.0.1',()=>console.log(`Ragniel preview: http://127.0.0.1:${port}/preview/mercenary-ragniel-v1/`));
