(() => {
  ...
  const data = {
    ...
    scoring: { equipmentPowerBounds:{ min:1200, max:360000 }, equipmentScoreRange:{ min:25, max:250 }, cardGradeBonus:{ LIMITED:120, PRESTIGE:180, FUR:240, ZENITH:320 }, cardRewardGradeFactor:{ LIMITED:1, PRESTIGE:.62, FUR:.46, ZENITH:.18 }, rewardCurve:{ name:'BLACK_MIRACLE_INVERSE', minFactor:.1, maxFactor:1, exponent:1.35 } },
    tiers: [
    ...
    rewardPool: [
      ...
      { rewardId: 'OD_LIMITED', mode: 'ANY', tierCode: 'OVERDRIVE', type: 'CARD', id: 'CN-0505936A0CBB4E59', name: '구수댕', member: '남수댕', rarity: 'LIMITED', basePower:18600, uniqueEffectScore:31, strengthPercent:36, image: 'assets/cards/남수댕/031.webp', weight: 100, effectiveWeight:76.92, autoFactor:.7692, gradeFactor:1, active: true, valid: true, color: '#ffd36f' },
      { rewardId: 'OD_PRESTIGE', mode: 'ANY', tierCode: 'OVERDRIVE', type: 'CARD', id: 'CN-57C561CA1F874657', name: '류하', member: '류하', rarity: 'PRESTIGE', basePower:22600, uniqueEffectScore:46, strengthPercent:54, image: 'assets/cards/newcard0730/7979.jpg', weight: 100, effectiveWeight:37.1, autoFactor:.5984, gradeFactor:.62, active: true, valid: true, color: '#e8c066' },
      { rewardId: 'OD_FUR', mode: 'ANY', tierCode: 'OVERDRIVE', type: 'CARD', id: 'CN-0B48C6FF8F9B4AC5', name: 'Faker', member: 'Faker', rarity: 'FUR', basePower:25600, uniqueEffectScore:58, strengthPercent:67, image: 'assets/cards/7777777.jpg', weight: 100, effectiveWeight:25.28, autoFactor:.5496, gradeFactor:.46, active: true, valid: true, color: '#e75f67' },
      ...
      { rewardId: 'FB_LIMITED', mode: 'ANY', tierCode: 'FORBIDDEN', type: 'CARD', id: 'CN-0505936A0CBB4E59', name: '구수댕', member: '남수댕', rarity: 'LIMITED', basePower:18600, uniqueEffectScore:31, strengthPercent:36, image: 'assets/cards/남수댕/031.webp', weight: 100, effectiveWeight:76.92, autoFactor:.7692, gradeFactor:1, active: true, valid: true, color: '#ffd36f' },
      { rewardId: 'FB_PRESTIGE', mode: 'ANY', tierCode: 'FORBIDDEN', type: 'CARD', id: 'CN-57C561CA1F874657', name: '류하', member: '류하', rarity: 'PRESTIGE', basePower:22600, uniqueEffectScore:46, strengthPercent:54, image: 'assets/cards/newcard0730/7979.jpg', weight: 100, effectiveWeight:37.1, autoFactor:.5984, gradeFactor:.62, active: true, valid: true, color: '#e8c066' },
      { rewardId: 'FB_FUR', mode: 'ANY', tierCode: 'FORBIDDEN', type: 'CARD', id: 'CN-0B48C6FF8F9B4AC5', name: 'Faker', member: 'Faker', rarity: 'FUR', basePower:25600, uniqueEffectScore:58, strengthPercent:67, image: 'assets/cards/7777777.jpg', weight: 100, effectiveWeight:25.28, autoFactor:.5496, gradeFactor:.46, active: true, valid: true, color: '#e75f67' },
      { rewardId: 'FB_ZENITH', mode: 'ANY', tierCode: 'FORBIDDEN', type: 'CARD', id: 'CN-A5A786E91B314805', name: '봉순', member: '나무늘봉순', rarity: 'ZENITH', basePower:32000, uniqueEffectScore:82, strengthPercent:98, image: 'assets/cards/bongson2.jpg', weight: 100, effectiveWeight:2.23, autoFactor:.1238, gradeFactor:.18, active: true, valid: true, color: '#6fe9dc' },
