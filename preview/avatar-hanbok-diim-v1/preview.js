...
for(const button of tabs)button.addEventListener('click',()=>{
  ...
  if(button.dataset.view==='loadout'&&!loadout)loadout=window.SoopketmonCharacterLoadoutV2.create(document.getElementById('avatarLoadoutReview'),{
    assetBase:'../../',profile:{nickname:'한복디임 이미지 검수'},
    data:{loadout:{},instances:[],titles:[],vehicles:[],bonuses:{},equippedAvatar:{code:'HANBOK_DIIM',name:'한복디임',equipmentImage:'preview/avatar-hanbok-diim-v1/assets/avatar-hanbok-diim-equipment-v1-640.webp'}},
