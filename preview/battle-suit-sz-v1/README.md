...
사용자 외형 승인과 무기 착용 리소스 제작·기술 검수를 완료한 독립 검수판이다. 등록 코드는 `BATTLE_SUIT_S_BODY`, `BATTLE_SUIT_Z_BODY`이며 운영 장비 수치·획득 경로·V3 라이브 연결은 별도 지시로 관리한다. 외형 승인과 라이브 연결을 구분하는 [배틀슈트 기준](../../docs/project-v-account-battle-suit-standard.md)을 따른다.
