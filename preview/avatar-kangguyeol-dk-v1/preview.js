...
for(const button of tabs)button.addEventListener('click',()=>{
  ...
  if(button.dataset.view==='loadout'&&!loadout)loadout=window.SoopketmonCharacterLoadoutV2.create(document.getElementById('avatarLoadoutReview'),{
    assetBase:'../../',profile:{nickname:'DK 강구열 이미지 검수'},
    data:{loadout:{},instances:[],titles:[],vehicles:[],bonuses:{},equippedAvatar:{code:'KANGGUYEOL_DK',name:'DK 강구열',equipmentImage:'preview/avatar-kangguyeol-dk-v1/assets/avatar-kangguyeol-dk-equipment-v1-640.webp'}},
