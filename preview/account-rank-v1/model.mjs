...
export const POLICY = Object.freeze({maxLevel:250,startLevel:1,retroactiveXp:false,pvpBuff:false,status:'PROPOSAL',dailyXpCap:null,targetDays:50,referenceDailyXp:2800,xpScope:'ALL_PVE'});
// Review amounts per server-settled event, not attendance requirements or caps.
export const XP_SOURCES=Object.freeze([
  {code:'HUNT',name:'몬스터 토벌',unit:'클리어',xp:80,example:10,note:'일반·상위 난이도 · 소탕 포함'},
  {code:'APOCALYPSE',name:'아포칼립스',unit:'클리어',xp:240,example:0,note:'정상 전투 정산'},
  {code:'RAID',name:'월드 레이드',unit:'전투 정산',xp:200,example:3,note:'보스 처치 전 유효 참여 포함'},
  {code:'ESCORT',name:'호송작전',unit:'작전 정산',xp:300,example:1,note:'콘텐츠 정산 기록 기준'},
  ...
  {code:'IDLE',name:'방치형 원정',unit:'정산 시간',xp:60,example:0,note:'1시간당 · 실제 정산 시간 비례'},
  {code:'TOWER',name:'무한의탑',unit:'층 클리어',xp:100,example:5,note:'재등반도 경험치 지급'},
  {code:'SCRAPYARD',name:'폐차장',unit:'원정 정산',xp:200,example:3,note:'전체 구역의 완료 정산'},
  {code:'COW_ROOM',name:'카우방',unit:'클리어',xp:300,example:0,note:'입장 콘텐츠 완료 정산'}
].map(Object.freeze));
