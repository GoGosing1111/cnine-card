...
const root=path.resolve(fileURLToPath(new URL('../..',import.meta.url))),port=Number(process.env.ICE_PREVIEW_PORT||8818);
...
http.createServer((req,res)=>{
 try{
  ...
  const localCandidate=relative==='assets/ui/project-v/mercenaries/mercenary-system-roster-v1.json'
   ?'preview/mercenary-ice-crystal-dual-sword-v1/release/roster.json':relative;
...
}).listen(port,'127.0.0.1',()=>console.log(`Ice dual-sword preview: http://127.0.0.1:${port}/preview/mercenary-ice-crystal-dual-sword-v1/`));
