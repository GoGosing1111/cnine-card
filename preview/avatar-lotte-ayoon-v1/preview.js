...
for(const button of tabs)button.addEventListener('click',()=>{
  ...
  if(button.dataset.view==='loadout'&&!loadout)loadout=window.SoopketmonCharacterLoadoutV2.create(document.getElementById('avatarLoadoutReview'),{
    assetBase:'../../',profile:{nickname:'롯데 아윤 이미지 검수'},
    data:{loadout:{},instances:[],titles:[],vehicles:[],bonuses:{},equippedAvatar:{code:'LOTTE_AYOON',name:'롯데 아윤',equipmentImage:'preview/avatar-lotte-ayoon-v1/assets/avatar-lotte-ayoon-equipment-v1-640.webp'}},
