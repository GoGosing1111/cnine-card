...
const root=path.resolve(fileURLToPath(new URL('../..',import.meta.url))),port=Number(process.env.MANGISA_PREVIEW_PORT||8806);
...
}).listen(port,'127.0.0.1',()=>console.log(`Mangisa preview: http://127.0.0.1:${port}/preview/mercenary-mangisa-v1/`));
