...
수치와 성공 조건은 검수용이며 운영 난이도·피해·보상 정책이 아니다. 신규 기믹을 운영 타임라인에 배정하거나 서버 판정에 연결하지 않았다.
...
- V3 실제 렌더러는 `../project-v-v3/project-v-pixi-battle.bundle.js?v=101-nonblocking-fx`, 제어 브리지는 `../../js/battle-v3-live.js?v=3.30.0-battle-suit-per-action-fire`다. 잠금 버전은 PixiJS 8.20.0 / GSAP 3.13.0이다. 번들을 새로 만들거나 라이브러리를 중복 로드하지 않았다.
