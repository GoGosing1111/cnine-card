(()=>{
  ...
  const requirements={eligibleGrades:['FUR','ZENITH'],minBreakthrough:13,costMasterStars:1000};
  ...
  const fixtures={
    ready:{label:'전직 가능 서버 응답',data:{cardId:'PREVIEW-ZENITH-13',current:null,grade:'ZENITH',breakthroughLevel:13,dominantType:'ATTACK',classInfo,requirements,wallet:{masterStars:2840},eligibility:{eligible:true,reasons:[]},canAdvance:true}},
    level:{label:'+12 조건 잠금',data:{cardId:'PREVIEW-FUR-12',current:null,grade:'FUR',breakthroughLevel:12,dominantType:'SPEED',classInfo:{...classInfo,code:'SERVER_PREVIEW_SPEED',name:'잔영자'},requirements,wallet:{masterStars:2840},eligibility:{eligible:false,reasons:['강화 +13 달성 후 전직할 수 있습니다.']},canAdvance:false}},
