...
const result=await build({
  ...
  define:{__CNINE_NATIVE_CONTINUOUS__:'true'}
});
...
await writeFile(path.join(here,'build-report.json'),JSON.stringify({status:'USER_APPROVED_SHARED_LIVE_RUNTIME',runtime,pixiVersion:'8.20.0',gsapVersion:'3.13.0',
