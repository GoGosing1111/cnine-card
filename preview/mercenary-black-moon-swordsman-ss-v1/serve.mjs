...
const root=path.resolve(fileURLToPath(new URL('../..',import.meta.url))),port=Number(process.env.BLACK_MOON_PREVIEW_PORT||8822);
...
}).listen(port,'127.0.0.1',()=>console.log(`Black Moon preview: http://127.0.0.1:${port}/preview/mercenary-black-moon-swordsman-ss-v1/`));
