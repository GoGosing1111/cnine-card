...
for(const button of tabs)button.addEventListener('click',()=>{
  ...
  if(button.dataset.view==='loadout'&&!loadout)loadout=window.SoopketmonCharacterLoadoutV2.create(document.getElementById('avatarLoadoutReview'),{
    assetBase:'../../',profile:{nickname:'FM 딤우스 이미지 검수'},
    data:{loadout:{},instances:[],titles:[],vehicles:[],bonuses:{},equippedAvatar:{code:'FM_DIMWOOS',name:'FM 딤우스',equipmentImage:'preview/avatar-fm-dimwoos-v1/assets/avatar-fm-dimwoos-equipment-v1-640.webp'}},
