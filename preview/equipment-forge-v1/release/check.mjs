...
export function checkPreparation() {
  ...
  // This preparation check deliberately refuses a hidden, partial runtime activation.
  for (const path of ['index.html', 'js/app.js', 'js/equipment-v1274.js', 'functions/api/[[path]].js', 'functions/_equipment.js', 'service-worker.js']) {
    if (/equipment-forge-v1|character\/equipment\/forge|ForgeSimulation/.test(read(path).toString())) errors.push(`준비 단계에 운영 연결이 추가됨: ${path}`);
  }
