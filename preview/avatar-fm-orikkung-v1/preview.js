...
for(const button of tabs)button.addEventListener('click',()=>{
  ...
  if(button.dataset.view==='loadout'&&!loadout)loadout=window.SoopketmonCharacterLoadoutV2.create(document.getElementById('avatarLoadoutReview'),{
    assetBase:'../../',profile:{nickname:'FM 오리꿍 이미지 검수'},
    data:{loadout:{},instances:[],titles:[],vehicles:[],bonuses:{},equippedAvatar:{code:'FM_ORIKKUNG',name:'FM 오리꿍',equipmentImage:'preview/avatar-fm-orikkung-v1/assets/avatar-fm-orikkung-equipment-v1-640.webp'}},
