...
if(codeOnly)assets.push(...JSON.parse(await readFile(path.join(dir,'build-report.json'),'utf8')).assets);
if(!codeOnly){
...
console.log('8-way homing preview built'+(codeOnly?' (code only; approved asset bytes preserved).':'.'));
