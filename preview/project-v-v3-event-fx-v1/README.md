# PROJECT V V3 Event FX + Combat SFX Preview V4
...
- 치명타 V3는 과도한 금속 고역과 피크로 폐기했습니다.
- 치명타 V4는 금속 쨍음을 제거하고 검풍·둔중 충격·저역 감쇠만 사용합니다. 실측 약 -18.7 LUFS, -3.0 dBTP, 최종 9.5 kHz 로우패스로 청취 피로를 낮췄습니다.
