...
- 48 kHz / 스테레오 / MP3 256 kbps. 검수 통과한 2~6번 V2는 기존 마스터를 유지하고, 치명타 V4만 실측 약 -18.7 LUFS / -3.0 dBTP로 낮췄습니다.
...
- 치명타 V3는 금속 고역과 피크가 과도해 폐기했습니다. V4는 금속 충돌 원음을 제외하고 Fast impact blow·검풍·저역 충격파를 사용하며, 실측 약 -18.7 LUFS / -3.0 dBTP와 9.5 kHz 로우패스로 다시 마스터링했습니다.
