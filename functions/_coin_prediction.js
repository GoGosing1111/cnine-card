...
// 2026-09-26: 이벤트당 유저 배팅 누적 한도 20억 -> 50억
// 이 상수를 바꾸면 foundation() 의 마이그레이션이
// 저장된 설정(app_meta)과 진행 중인 DRAFT/OPEN 이벤트의 max_bet 까지 자동으로 맞춘다.
const USER_MAX_BET_PER_EVENT=5000000000;
const DEFAULTS=Object.freeze({enabled:true,feePercent:10,minBet:MIN_BET,maxBetPerEvent:USER_MAX_BET_PER_EVENT,pollSeconds:10,termsVersion:'2026-09-26'});
