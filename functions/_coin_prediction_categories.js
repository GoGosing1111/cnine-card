...
export const PREDICTION_CATEGORIES = Object.freeze(['SOCCER', 'BASEBALL', 'BASKETBALL', 'LOL', 'SETKA', 'OTHER']);
...
export const PREDICTION_CATEGORY_SQL = `CASE WHEN pc.value IN ('SOCCER','BASEBALL','BASKETBALL','LOL','SETKA','OTHER') THEN pc.value ELSE 'OTHER' END`;
