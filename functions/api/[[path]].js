...
async function handleRequest(context){
  ...
  try{
    ...
    if(path==='battle/config'){
      ...
      return json({settings,deck,deckRules:deckRulesContract('PVE'),characterBonus,energy,apocalypseEnergy,serverNow:new Date().toISOString(),monsters:publicMonsters,burningEvent:burningPublicState(burning),battleEngine:battleEngineState(settings,user)});
    }
