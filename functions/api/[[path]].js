...
function riftBuffCatalog(){return [
  ...
  {key:'CRYSTAL_GREED',name:'마법 결정 탐욕',icon:'◇',description:'노드 보상 마법 결정이 40% 증가하지만 받는 피해가 10% 증가합니다.',crystalPercent:40,damageTakenPercent:10}
];}
