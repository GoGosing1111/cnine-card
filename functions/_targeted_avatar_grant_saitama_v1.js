...
export const TARGETED_AVATAR_GRANT_MARKER_KEY='targeted_avatar_grant_saitama_terran_empress_joeun_20260909_v1';
export const TARGETED_AVATAR_GRANT_NICKNAME='싸이타마';
export const TARGETED_AVATAR_GRANT_CODE='TERRAN_EMPRESS_JOEUN';

const TARGETED_AVATAR_GRANT_NAME='테란여제 조은';
const TARGETED_AVATAR_GRANT_ACTION='SYSTEM_AVATAR_GRANT_SAITAMA_V1';
const TARGETED_AVATAR_GRANT_VERIFICATION_TABLE='targeted_avatar_grant_saitama_v1_verifications';
...
export async function ensureTargetedAvatarGrantSaitamaV1(env){
  ...
  console.log('TARGETED_AVATAR_GRANT_SAITAMA_V1',JSON.stringify({status:stored.status,version:stored.version,avatarCode:stored.avatarCode,permanent:stored.permanent,replayed:stored.replayed}));
  return stored;
}
