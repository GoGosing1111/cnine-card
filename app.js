...
let raidState={timer:null,data:null,lastAttackTicks:-1,settledInstanceId:Number(sessionStorage.getItem('cnineRaidSettledInstance')||0)};
...
function renderRaidView(d){
  ...
  if(c.status==='ENDED'&&raidState.settledInstanceId===Number(c.id)){box.innerHTML=`<section class="raid-empty raid-empty-polished"><p class="eyebrow">RAID SETTLED</p><h2>보상 정산 완료</h2><p>해당 레이드 보상은 이미 지급되었습니다.</p></section>`;stopRaidTimer();return;}
