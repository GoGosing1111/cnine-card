...
async function startBattle(){
  ...
  }finally{battleState.fightStarting=false;if(entryButton?.isConnected){entryButton.disabled=false;entryButton.textContent=entryButtonLabel}}
}
