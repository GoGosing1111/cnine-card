...
export const MERCENARY_ART_RELEASE_VERSION='20260915-hi-heeya-v1';
export const MERCENARY_ART_RELEASES=Object.freeze([
  Object.freeze({code:'V-044',name:'하이희야',title:'백색의 기관총 사수',rank:'SS',
    ...
    sourceArt:'assets/ui/project-v/mercenaries/approved-20260915/mercenary-v044-hi-heeya-source-art-v1.png',
    battleSprite:null,accent:'#7bcbe3',basePower:null,skills:Object.freeze([]),
    weapon:'경기관총',basicTarget:'추후 공개',specialty:'추후 공개',weakness:'추후 공개'})
]);
