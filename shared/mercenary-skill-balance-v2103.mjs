...
export function applyMercenaryBalanceV2103(document,catalog){
 ...
 if(result.skills.filter(s=>!['MS-044','MS-045','MS-046','MS-047','MS-048','MS-049'].includes(s.id)).length!==MERCENARY_SKILL_BALANCE_V2103.length)throw Error('스킬 목록이 변경됐습니다. 새 목록을 확인하세요.');
