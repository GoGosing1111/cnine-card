...
export const V3_LIVE_CONNECTIONS=Object.freeze({
  ...
  SCRAPYARD:{label:'폐차장',url:'/pve-v3/?content=scrapyard',state:'scrapyard/v3/state',run:'scrapyard/v3/run',result:'scrapyard/v3/result'},
  COW_ROOM:{label:'카우방',url:'/pve-v3/?content=cow-room',state:'cow-room/v3/state',run:'cow-room/v3/run',result:'cow-room/v3/result',portals:'cow-room/v3/portals'},
});
