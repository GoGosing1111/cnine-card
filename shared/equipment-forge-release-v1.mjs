...
// This immutable launch's material identity. A different item needs a new release.
export const EQUIPMENT_FORGE_RELEASE_PROTECTION_CODE='EQUIPMENT_PROTECTION_TICKET';
