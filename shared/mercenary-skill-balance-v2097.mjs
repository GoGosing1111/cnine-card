...
export function applyMercenaryBalanceV2097(document,catalog) {
  ...
  if(result.skills.filter(s=>!['MS-044','MS-045','MS-046','MS-047','MS-048','MS-049','MS-050','MS-051'].includes(s.id)).length!==MERCENARY_SKILL_BALANCE_V2097.length)throw Error('스킬 목록 변경: 초안을 다시 검수하세요.');
