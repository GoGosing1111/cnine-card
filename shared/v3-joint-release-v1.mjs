...
export function v3JointReleaseState(){
  return {version:V3_JOINT_RELEASE_VERSION,enabled:V3_JOINT_RELEASE_ENABLED,components:[...V3_JOINT_COMPONENTS],connected:true,connections:V3_LIVE_CONNECTIONS,publicContent:pvePublicContentState()};
}
