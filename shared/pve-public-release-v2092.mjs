...
export function pvePublicContentState(){return {
  TOWER:{enabled:true,policy:TOWER_LIVE_POLICY,reAscentEnabled:false,url:TOWER_LIVE_URL},
  COW_ROOM:{enabled:COW_ROOM_PUBLIC_RELEASE_ENABLED,policy:'CMS',url:'/pve-v3/?content=cow-room'},
  SCRAPYARD:{enabled:SCRAPYARD_PUBLIC_RELEASE_ENABLED,policy:'CMS',url:'/pve-v3/?content=scrapyard'}
};}
