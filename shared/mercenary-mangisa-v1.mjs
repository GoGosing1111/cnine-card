...
export function createMangisaSkill(definition,art){
 return definition(MANGISA_SKILL_ID,'금란 연사','MARKSMAN','FRONT_ENEMY',MANGISA_MECHANIC,
  ...
  '화이트 골드 AK로 주 대상에게 6연사합니다. 총 피해 예산의 80%를 주 대상에게, 마지막 탄의 확산으로 주변 적 최대 2명에게 각각 10%를 가합니다. SS등급의 PVP 피해와 피해 상한은 82%입니다.',
  '회피·보호막·피해 경감은 적용됩니다. 앞선 탄이 빗나가도 계속 발사합니다. 주 대상 소멸·시전자 제압 시 남은 탄은 취소되며 남은 피해를 다른 표적에 이전하지 않습니다.',
