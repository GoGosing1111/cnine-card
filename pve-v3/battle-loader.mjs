...
try{await load(content==='idle-dungeon'?'/preview/project-v-v3/project-v-pixi-battle.bundle.js?pveEntry=2117':'/pve-v3/battle.bundle.js?pveEntry=2117');await load('/js/battle-v3-live.js');await import('./battle-bridge.mjs');window.dispatchEvent(new Event('pve-v3-ready'));}
