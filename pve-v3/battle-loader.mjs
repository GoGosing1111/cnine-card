...
try{await load(content==='idle-dungeon'?'/preview/project-v-v3/project-v-pixi-battle.bundle.js?pveEntry=2119&heeya=2118&zSword=20260918':'/pve-v3/battle.bundle.js?pveEntry=2119&heeya=2118&zSword=20260918');await load('/js/battle-v3-live.js?zSword=20260918');await import('./battle-bridge.mjs');window.dispatchEvent(new Event('pve-v3-ready'));}
