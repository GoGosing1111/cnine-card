...
for(const file of ['preview/project-v-v3/source/battle/RagnielCombatPlayback.js','preview/mercenary-ragniel-v1/source/RagnielSkillFX.js','preview/mercenary-ragniel-v1/skill.mjs','shared/mercenary-ragniel-v1.mjs','preview/project-v-v3/source/battle/MangisaCombatPlayback.js','preview/mercenary-mangisa-v1/source/MangisaSkillFX.js','preview/battle-suit-skill-chip-v1/source/SkillChipAudio.js','preview/project-v-mercenary-system-v1/skill-audio-v1.json','assets/ui/project-v/mercenaries/mercenary-attachment-points-v1.json'])sources.push({file,sha256:hash(await readFile(file,'utf8'))});
