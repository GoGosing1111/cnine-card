...
for (const name of ['BattleEngine.js', 'BattleCharacter.js', 'ObjectPool.js', 'OccupiedGridLayout.js', 'FormationLayout.mjs', 'ViewportLayout.mjs','MercenaryCombatPlayback.js','MercenaryRoleAttackFX.js','ProjectileTrail.mjs']) {
