...
const nativeCards=catalog.map((c,i)=>({...c,id:ids[i],title:c.member,rarity:'FUR',grade:'FUR',powerType:['ATTACK','DEFENSE','SPEED','HP','ATTACK'][i],basePower:qaCardPower,image:c.sourceArt}));
