...
const server=http.createServer(async(req,res)=>{try{
  ...
  if(!target.startsWith(root+path.sep)||rel.split(/[\\/]/).some(s=>s==='..'||s.startsWith('.'))||!pure&&!['pve-v3','mercenary-codex','mercenary-hangar','equipment-forge','preview','assets','css','js','shared','style.css'].includes(rel.split('/')[0]))return send(res,404,{});
