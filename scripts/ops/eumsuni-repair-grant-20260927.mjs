...
export const OPERATION_KEY='ops:eumsuni-repair-coupon:20260927:v1';
...
const REASON='사용자 지시: 음순이 리페어권 2장 지급';
...
export async function grantEumsuniRepairCoupon(client,{dryRun=false}={}){
