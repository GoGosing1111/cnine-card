...
export const OPERATION_KEY='ops:kangguyeol-repair-coupon:20260927:v1';
export const TARGET=Object.freeze({id:4718,nickname:'강구열'});
export const ITEM_CODE='PINGDU_REPAIR_COUPON';
export const ITEM_NAME='핑두 리페어 쿠폰';
const REASON='사용자 지시: 강구열 리페어권 2장 지급';
...
export async function grantKangGuyeolRepairCoupon(client,{dryRun=false}={}){
