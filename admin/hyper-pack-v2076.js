...
(()=>{
 ...
 function mount(){const target=document.getElementById('packManager');if(!target||panel)return;
  ...
  panel.innerHTML='<div class="hyper-admin-top"><div><small>EXTREME HYPER PACK / LIVE CONNECTION</small><h3>하이퍼팩 · 용병카드 개봉</h3><p>1회 <b>5억 코인</b> · 최대 10회 <b>50억 코인</b><br>꽝 · 마스터의 별 · 미스틱 에너지 · C~SSS 용병카드</p></div><img src="/assets/ui/packs/hyper-pack-v2076.png" alt="하이퍼팩"></div><p>실제 개봉은 용병 운영실에 저장된 등급별 확률·지급 수량을 사용합니다. 같은 등급 안에서는 저장된 용병별 가중치로 추첨하며, 중복은 카드별로 집계합니다. 이전 4종 확률 초안은 운영 추첨에 사용하지 않습니다.</p><div class="hyper-admin-actions"><a href="#mercenaries/draw">운영 개봉 확률 설정</a><a href="/?screen=buy&amp;pack=hyper" target="_blank" rel="noopener">실제 카드팩 상점 ↗</a><a href="/mercenary-codex/?view=owned" target="_blank" rel="noopener">보유 용병 확인 ↗</a></div><div data-hyper-opening></div>';
