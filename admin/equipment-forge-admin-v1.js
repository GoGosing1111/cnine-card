...
function renderPublic(){
  ...
  if(form){form.oninput=()=>dirty=true;form.onsubmit=async event=>{
    event.preventDefault();if(busy)return;const formData=new FormData(form),settings={publicVisible:formData.get('publicVisible')==='true',executionMode:'OFF',notice:String(formData.get('notice'))};
