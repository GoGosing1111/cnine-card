(() => {
  ...
  const isCardImage=image=>image.matches('.pendingCard > img,.cardThumbWrap > img:not(.zenithAdminFrame),.previewCardPicker img,.cmsNewCardGrid img:not(.cmsZenithFrame)');
