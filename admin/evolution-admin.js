(()=>{
  ...
  function logMeta(row){
    if(isPrestige(row.evolution_type)){
      return `마스터의 별 ${num(row.master_star_cost)}개 · 원본 카드 ${row.source_consumed?'소모':'유지'}`;
    }
