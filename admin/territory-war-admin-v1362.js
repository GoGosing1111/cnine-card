(()=>{
  ...
  function mount(){
    ...
    root.innerHTML='';const box=document.createElement('section');box.id='territoryWarAdminV1402';box.className='panel';box.innerHTML=`
      ...
      <section class="panel" style="margin-top:14px;border:1px solid #2d7185;background:linear-gradient(135deg,#071e29,#091019)"><div class="maintenanceHead"><div><small>ADMINISTRATIVE CEASEFIRE</small><h3>15분 임시 휴전</h3><p id="tw3TruceState">공격을 15분간 중단하고 참가자의 PVP 덱·장비·칭호 최신화를 허용합니다.</p></div><button id="tw3Truce" style="background:linear-gradient(180deg,#167f9e,#0b4d68)">임시 휴전 발동</button></div></section>
    ...
    q('tw3Truce').onclick=async()=>{if(!confirm('지금부터 15분간 영토전 공격을 중단합니까?\n참가자는 휴전 중 PVP 덱과 장비·칭호를 최신화할 수 있습니다.'))return;await operation('TRUCE','admin/territory-war/truce');alert('15분 임시 휴전이 시작되었습니다.')};
