(()=>{
  ...
  function mount(){
    ...
    function setBusy(action=''){busy=action;['tw3Save','tw3ResetRecruit','tw3Start','tw3Finish','tw3Reload','tw3MassAssaultFire'].forEach(id=>{const button=q(id);if(button)button.disabled=Boolean(action)})}
