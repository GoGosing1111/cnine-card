...
export const TROPHY_CATALOG = Object.freeze([
  { code: 'DUO_CHALLENGER', name: '듀오 챌린저', category: 'DUO CHALLENGER', rule: '공식 듀오 시즌 종료 시 최종 1~10위 팀의 두 사람에게 각각 시즌당 1개 지급', art: '/assets/ui/ranked-duo/challenger-trophy-v1.webp', tone: 'blue' },
