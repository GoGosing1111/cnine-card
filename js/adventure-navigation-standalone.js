...
(function(global){
  ...
  function start(){
    ...
    const visibility={avatar:false,alchemy:false,wishLamp:false};
    ...
    async function refreshVisibility(){
      ...
      const [summary,wish]=await Promise.allSettled([read('shell/summary'),read('events/wish-lamp/feature')]);
      ...
      if(wish.status==='fulfilled')visibility.wishLamp=wish.value.visible===true&&wish.value.phase!=='ENDED';
