...
(function(global){
  ...
  function start(){
    ...
    const visibility={avatar:false,alchemy:false,chuseok:false};
    ...
    async function refreshVisibility(){
      ...
      const [summary,chuseok]=await Promise.allSettled([read('shell/summary'),read('events/chuseok/feature')]);
      ...
      if(chuseok.status==='fulfilled')visibility.chuseok=chuseok.value.visible===true;
