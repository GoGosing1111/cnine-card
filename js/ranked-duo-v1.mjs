...
function style(){
 ...
 const link=document.createElement('link');link.rel='stylesheet';link.href='/css/ranked-duo-v1.css?v=20260925-3';link.dataset.duoStyle='1';document.head.append(link);
}
