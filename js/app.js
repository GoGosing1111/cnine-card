...
function playerIdentityHtml(nickname,userId){return window.PlayerCallingCard?.nameHtml(nickname,userId)||escapeHtml(nickname||'-')}
...
const FEATURE_RESOURCE_MANIFEST={
  ...
  scrapyard:{
    ...
    scripts:['js/workshop-v1881.js?v=2098-hyper-codex&joint=2090','js/scrapyard-battle-v1698.js?v=2098-hyper-codex'],
