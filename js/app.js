...
function cardHtml(card, owned, classes='', user=loadUser()) {
  ...
  const fakerFrame=isFakerChampionship?'<img class="faker-championship-frame" src="assets/ui/card-frames/faker-t1-championship-frame-v2.png" alt="" aria-hidden="true"><img class="faker-t1-mark" src="assets/ui/brands/t1-logo-red-official-cropped.png" alt="T1"><img class="faker-signature-mark" src="assets/ui/card-frames/faker-signature-wordmark-v1.png" alt="Faker"><span class="faker-t1-subtitle">THE UNKILLABLE DEMON KING</span>':'';
