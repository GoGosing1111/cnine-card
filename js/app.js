...
let raidState={timer:null,data:null,resultRevealed:new Set()};
...
function renderRaidView(d){
  ...
  const c=d.current,s=d.settings||{},schedule={...(d.schedule||{isOpen:true,canEnter:true}),canEnter:Boolean((d.schedule||{canEnter:true}).canEnter)&&!d.dailyEntryUsed};
