...
function battleTriggerUniqueFx(stage,index,event='attack',enemy=false){
  ...
  fx.style.left=`${fighterRect.left-stageRect.left}px`;fx.style.top=`${fighterRect.top-stageRect.top}px`;fx.style.width=`${fighterRect.width}px`;fx.style.height=`${fighterRect.height}px`;
