...
const WORLD_MAPS={
 town:{name:'씨켓몬 마을',w:1800,h:1250,spawn:{x:860,y:850},grass:{x:1120,y:690,w:560,h:420},exits:[{x:820,y:1180,w:170,h:60,to:'field',tx:800,ty:100}],buildings:[
  ...
  {id:'hall',x:300,y:660,w:350,h:260,label:'모험 안내소',tab:'attendance'}],npcs:[{id:'chulgu',x:700,y:560,label:'철구',sprite:'npcChulgu',dialog:['씨켓몬 마을에 온 걸 환영한다!','강한 덱을 만들고 초원으로 나가봐.']},{id:'jjeomni',x:830,y:545,label:'졈니',sprite:'npcJjeomni',dialog:['카드 상점에는 다양한 카드팩이 있어.','좋은 카드가 나오길 응원할게!']},{id:'jjeomjung',x:960,y:565,label:'점중',sprite:'npcJjeomjung',dialog:['랭킹은 꾸준히 도전해야 올라갈 수 있어.'],tab:'rank'},{id:'yeonji',x:1090,y:545,label:'연지',sprite:'npcYeonji',dialog:['반가워! 오늘도 즐거운 모험 되길 바라.'],tab:'mineral'},{id:'boy',x:570,y:835,label:'마을 소년',sprite:'npcBoy',dialog:['초원에서는 갑자기 몬스터가 나타나!']},{id:'girl',x:1230,y:820,label:'마을 소녀',sprite:'npcGirl',dialog:['나는 카드 도감을 모으는 중이야.']},{id:'elder',x:540,y:420,label:'장로',sprite:'npcElder',dialog:['옛날부터 이 마을에는 희귀 카드 전설이 내려왔지.']},{id:'guard',x:1180,y:430,label:'경비대',sprite:'npcGuard',dialog:['PVP 경기장은 오른쪽 위에 있다.']},{id:'researcher',x:850,y:300,label:'연구원',sprite:'npcResearcher',dialog:['카드 점수와 전투력을 연구하고 있어.']},{id:'merchant',x:405,y:570,label:'행상인',sprite:'npcMerchant',dialog:['좋은 카드팩은 모험에서 얻을 수도 있어.']}]},
