...
const FEATURE_RESOURCE_MANIFEST={
  ...
  workshop:{
    ...
    scripts:['js/workshop-assembly-live-v2073.bundle.js?v=2073.1','js/workshop-v1881.js?v=2094-combat-only&joint=2090'],
  ...
  scrapyard:{
    ...
    scripts:['js/workshop-v1881.js?v=2094-combat-only&joint=2090','js/scrapyard-battle-v1698.js?v=2094-combat-only'],
  ...
  soopketland:{
    styles:['css/soopketland-v2039.css?v=2094-combat-only'],
    scripts:['js/ui-fx-vendor-v2045.bundle.js?v=2045','js/soopketland-v2039.bundle.js?v=2094-combat-only'],
  ...
  battleV2:{
    ...
    scripts:[
      ...
      'preview/project-v-v3/project-v-pixi-battle.bundle.js?v=104-pve-continuous&joint=2090',
      'js/battle-v3-live.js?v=3.34.0-pve-continuous'
    ],
