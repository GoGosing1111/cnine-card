...
function renderShell(tab) {
  ...
  const brand=document.querySelector('.header .brand');brand?.insertAdjacentHTML('afterend','<a class="fullscreen-play-link" href="https://cnine-card.pages.dev/" target="_blank" rel="noopener noreferrer" title="씨켓몬을 새 탭에서 크게 열기"><span>⛶</span><b>큰 화면으로 즐기기</b></a>');
