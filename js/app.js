...
const FEATURE_RESOURCE_MANIFEST={
  ...
  battleV2:{
    ...
    scripts:[
      ...
      'preview/project-v-v3/project-v-pixi-battle.bundle.js?v=64-escort-operation',
      'js/battle-v3-live.js?v=3.19.0-escort-operation'
    ],
