...
const FEATURE_RESOURCE_MANIFEST={
  ...
  battleV2:{
    ...
    scripts:[
      ...
      'preview/project-v-v3/project-v-pixi-battle.bundle.js?v=63-rpg-audio-fastload',
...
async function openInventoryPack(itemCode,ownedQuantity=0){
  ...
  const meta=reroll?{...reroll,range:`${reroll.grade} 활성 카드`,kind:'reroll'}:{...(cubeItems[itemCode]||cubeItems.PREMIUM_CUBE),kind:'cube'},modal=document.getElementById('modal'),bulkPremium=itemCode==='PREMIUM_CUBE'&&!reroll;
