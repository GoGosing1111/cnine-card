...
function applyPveViewMode(mode=getPveViewMode()){
  ...
  document.querySelectorAll('.pve-mode-btn').forEach(b=>b.classList.toggle('active',b.dataset.pveMode===mode || (mode!=='raid'&&b.dataset.pveMode==='deck'&&mode==='deck')));
  if(!hunt)return;
