...
function bindView(tab) {
  ...
  void import('./clan-faction-v1.mjs?v=2131-lineup').then(m=>m.connect({apiRequest,clearApiCache,renderShell,ensureFeatureResources,prepareImmediateBattleV3Entry,ensureBattleSoundButton,battleSfx})).catch(()=>{});
