...
function bindView(tab) {
  ...
  void import('./clan-faction-v1.mjs?v=20260920-tax-1b').then(m=>m.connect({apiRequest,clearApiCache,renderShell,ensureFeatureResources,prepareImmediateBattleV3Entry,ensureBattleSoundButton,battleSfx})).catch(()=>{});
