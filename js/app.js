...
let pvpState={tab:'match',config:null,profile:null,myTitle:null,deck:[],characterBonus:{equipmentPve:0,equipmentPvp:0,titlePve:0,pve:0,pvp:0},battleEngine:{active:false,version:'LEGACY',mode:'LEGACY'},opponents:[],history:[],ranking:[],energy:null,energyTimer:null,serverOffset:0};
