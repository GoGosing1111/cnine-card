...
const FEATURE_RESOURCE_MANIFEST={
  ...
  alchemy:{
    styles:['css/card.css?v=1973-alchemy-live','css/alchemy-v1.css?v=5-single-mode'],
    scripts:['js/alchemy-v1.js?v=5-single-mode','js/alchemy-v1-live.js?v=1-live-mount'],
