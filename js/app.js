...
const FEATURE_RESOURCE_MANIFEST={
  ...
  battleV2:{
    styles:['css/battle-v2-live.css?v=1727-offscreen-webgl-cleanup','css/battle-v3-live.css?v=3.0.0-live'],
    scripts:[
      ...
      'preview/project-v-v3/project-v-pixi-battle.bundle.js?v=43-live-runtime',
      'js/battle-v3-live.js?v=3.0.0-live'
    ],
...
async function startBattle(){
  ...
  modal.innerHTML=`<div class="modal-panel battle-stage intro">
    ...
    <div class="battle-topline"><span>${battleState.battleEngine?.active?'PROJECT V V3 · PIXIJS WEBGL':'SOOP PVE BATTLE'}</span><b id="battlePhase">ENCOUNTER</b></div>
