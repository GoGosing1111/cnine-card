...
const FRESH_ACCOUNT_SCRIPTS=new Set(['/js/adventure-lobby-v2107.js','/js/soopketmon-v21-exact-shell-adapter.js','/js/player-card-v2052.js','/js/account-rank-v1.mjs','/js/joint-account-transport.mjs']);
const SHELL_CORE=[
  OFFLINE_URL,
  APP_SHELL_URL,
